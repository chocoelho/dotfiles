         ...
         (when (and (file-directory-p dir)
           ...
           (let ((default-directory dir)
             ...
             (when (projectile-project-p)
               (projectile-add-known-project (file-name-as-directory (projectile-project-root)))))))
       subdirs)))
  )
